            ...
            >
                ...
                >
                    ...
                    <View style={styles.listSection}>
                        ...
                        <TouchableOpacity
                            style={[styles.listDropdown, { borderColor: theme.border, backgroundColor: theme.surface }]}
                            onPress={() => setShowListPicker(!showListPicker)}
                        >
                            <Text style={[styles.listDropdownText, { color: theme.text }]}>
                                {boardLists.find(l => l.id === selectedListId)?.name || 'Select List'}
                            </Text>
                        ...
                        {showListPicker && (
                            <View style={[styles.listPicker, { borderColor: theme.border, backgroundColor: theme.surface }]}>
                                {boardLists.map(list => (
                                    <TouchableOpacity
                                        key={list.id}
                                        style={[
                                            styles.listOption,
                                            selectedListId === list.id && { backgroundColor: theme.tint + '20' }
                                        ]}
                                        onPress={() => {
                                    ...
                                    >
                                        ...
                                        <Text style={[styles.listOptionText, { color: theme.text }]}>
                                            {list.name}
                                        </Text>
