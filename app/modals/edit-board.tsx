...
export default function EditBoardScreen() {
    ...
    const [boardThumbnailPhoto, setBoardThumbnailPhoto] = useState(board.thumbnailPhoto);
    ...
    const handleUpdateBoard = useCallback(() => {
        ...
        router.back();
    }, [validateForm, updateBoard, boardName, boardDescription, boardThumbnailPhoto, router]);
    ...
    return (
        <SafeAreaScreen edges={['bottom']} paddingTop={24}>
            ...
            >
                <ScreenHeader title={`Edit Board: ${board.name}`} />
                ...
                >
                    ...
                    <View style={styles.buttonContainer}>
                        <Button title="Update Board" onPress={handleUpdateBoard} />
                    </View>
                </ScrollView>
            </KeyboardAvoidingView>
        </SafeAreaScreen>
